...
public class SetHolidayRepository {

    private static final String TAG = "SetHolidayRepository";

    private GLApiService glApiService;

    public SetHolidayRepository() {
    ...
    public MutableLiveData<NothingResponse> getMutablesetHolidayData(String companyID,String date,String holiday_yn) {
        glApiService.setHoliday(companyID,date,holiday_yn).enqueue(new Callback<NothingResponse>() {
            @Override
